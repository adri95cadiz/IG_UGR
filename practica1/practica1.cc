...
void draw_objects()
{
	...
	switch(numModel){
			case 0: //Tetraedro
				if(displayAll)
				{
					tetraedro->visualizar(0);
					tetraedro->visualizar(1);
					tetraedro->visualizar(2);
				}
				else
			...
			case 1: //Cubo
				if(displayAll)
				{
					hexaedro->visualizar(0);
					hexaedro->visualizar(1);
					hexaedro->visualizar(2);
				}
				else
			...
			case 2: //Cono
				if(displayAll)
				{
					cornetto->visualizar(0);
					cornetto->visualizar(1);
					cornetto->visualizar(2);
				}
				else
			...
			case 3: //Cilindro
				if(displayAll)
				{
					cilindro->visualizar(1);
					cilindro->visualizar(2);
					cilindro->visualizar(3);
				}
				else
...
hexaedro = new Hexaedro(6);
tetraedro = new Tetraedro(6);
cornetto = new Cornetto(6, 4, 80);
cilindro = new Cilindro(6, 4, 120);
donut = new Donut(5, 1, 400);
